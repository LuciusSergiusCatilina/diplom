...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 07 2024 г., 12:07
...
(1, 1, 797, NULL, 'ул. Кутузная д.62 кв.6', '2024-02-04 11:21:10', '79004825567', 'Консультация'),
...
(30, 1, 22, NULL, 'Улица Зелёная, дом 3, квартира 78', '2024-05-07 11:12:00', '79000486213', 'Вызов бригады'),
(31, 1, 402, 11, 'Улица Островского, дом 213, квартира 78', '2024-05-07 11:21:31', '79994521212', 'Вызов бригады');
...
--
ALTER TABLE `calls`
  MODIFY `id_call` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
