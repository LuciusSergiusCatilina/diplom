...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 26 2024 г., 12:44
...
(1, 1, NULL, 4, 'ул. Кутузная д.62 кв.6', '2024-04-25 11:21:10', '79004825567', 'Консультация'),
(2, 1, 797, 9, 'ул. Восточная д. 233 кв. 765', '2024-04-25 11:21:46', '79994562218', 'Вызов бригады'),
(3, 1, 111, NULL, 'ул. Коновалова д.41', '2024-04-25 11:27:47', '79998456121', 'Вызов бригады'),
(4, 1, NULL, 4, 'ул. Достоевского д. 32', '2024-04-26 10:17:12', '79004562222', 'Консультация'),
(5, 1, 797, 4, 'ул. Шиловская д.51 кв.521', '2024-04-26 12:18:08', '79004825608', 'Вызов бригады');
...
--
ALTER TABLE `calls`
  MODIFY `id_call` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
